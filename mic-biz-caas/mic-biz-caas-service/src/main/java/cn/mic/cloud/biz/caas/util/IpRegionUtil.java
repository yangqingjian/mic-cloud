package cn.mic.cloud.biz.caas.util;
...
public class IpRegionUtil {
    ...
    static {
        ...
        if (!FileUtil.exist(existFile)) {
            InputStream resourceAsStream = IpRegionUtil.class.getResourceAsStream(fileName);
        ...
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("CommonIpAddressUtil初始化失败，原因：" + e.getMessage());
        }
    ...
    public static void main(String[] args) {
        log.info("182.150.41.58 = {}", getCityInfo("182.150.41.58"));
        log.info("124.70.83.65 = {}", getCityInfo("124.70.83.65"));
        log.info("117.174.23.255 = {}", getCityInfo("117.174.23.255"));
    }
}
